...
# 10 "cmf.cu"
__attribute__((global)) __attribute__((__used__)) extern void _Z8mykernelPf(float *);
# 18 "cmf.cu"
__attribute__((global)) __attribute__((__used__)) extern void _Z9mykernel2Pf(float *);
...
# 8255 "/usr/local/cuda/bin/..//include/math_functions.h" 3
# 1 "/usr/local/cuda/bin/..//include/device_functions.h" 1 3
# 3923 "/usr/local/cuda/bin/..//include/device_functions.h" 3
...
# 4034 "/usr/local/cuda/bin/..//include/device_functions.h" 3
...
{
# 4087 "/usr/local/cuda/bin/..//include/device_functions.h" 3
...
{
# 4202 "/usr/local/cuda/bin/..//include/device_functions.h" 3
  unsigned int expo_x, expo_y;
  unsigned int xxi, yyi, temp;
...
{
# 4331 "/usr/local/cuda/bin/..//include/device_functions.h" 3
  unsigned int e, i;
  unsigned int s, x;
...
# 5255 "/usr/local/cuda/bin/..//include/device_functions.h" 3
...
# 5530 "/usr/local/cuda/bin/..//include/device_functions.h" 3
    if ((((xx << 1) == 0) && ((yy << 1) == 0xff000000)) ||
        (((yy << 1) == 0) && ((xx << 1) == 0xff000000))) {
      return rsqrtf(__int_as_float(0xffc00000));
    }
...
# 5794 "/usr/local/cuda/bin/..//include/device_functions.h" 3
    if ((((xx << 1) == 0) && ((yy << 1) == 0xff000000)) ||
        (((yy << 1) == 0) && ((xx << 1) == 0xff000000))) {
      return rsqrtf(__int_as_float(0xffc00000));
    }
...
# 6063 "/usr/local/cuda/bin/..//include/device_functions.h" 3
    if ((((xx << 1) == 0) && ((yy << 1) == 0xff000000)) ||
        (((yy << 1) == 0) && ((xx << 1) == 0xff000000))) {
      return rsqrtf(__int_as_float(0xffc00000));
    }
...
# 4599 "/usr/local/cuda/bin/..//include/surface_functions.h" 3
...
# 3716 "/usr/local/cuda/bin/..//include/texture_fetch_functions.h" 3
...
# 9583 "/usr/local/cuda/bin/..//include/texture_fetch_functions.h" 3
...
# 8746 "/usr/local/cuda/bin/..//include/math_functions.h" 3
...
# 8804 "/usr/local/cuda/bin/..//include/math_functions.h" 3
...
static __inline__ __attribute__((always_inline)) float __internal_copysignf_pos(float a, float b)
{
...
static __inline__ __attribute__((always_inline)) float nextafterf(float a, float b)
{
  ...
  if (__int_as_float(ia) == 0.0f) {
    return __internal_copysignf_pos (1.175494351e-38f, b);
  }
...
static __inline__ __attribute__((always_inline)) float __internal_fast_rsqrtf(float a)
{
  float r;
...
static __inline__ __attribute__((always_inline)) float __internal_fast_log2f(float a)
{
  float r;
...
static __inline__ __attribute__((always_inline)) float __internal_fast_exp2f(float a)
{
  float r;
...
static __inline__ __attribute__((always_inline)) float __internal_accurate_logf(float a)
{
  ...
  if ((a > 0.0f) && (a < __int_as_float(0x7f800000))) {
    float e = -127.0f;
    int ia;
# 9038 "/usr/local/cuda/bin/..//include/math_functions.h" 3
    ia = __float_as_int(a);
    ...
    z = __internal_fmad (e, 0.693147181f, z);
  } else {
...
# 9169 "/usr/local/cuda/bin/..//include/math_functions.h" 3
  return z;
}
...
static __inline__ __attribute__((always_inline)) uint2 __internal_umad32wide (unsigned int a,
                                                    unsigned int b,
                                                    unsigned int c)
{
  uint2 res;
...
{
# 9490 "/usr/local/cuda/bin/..//include/math_functions.h" 3
  if (i & 1) {
...
static __inline__ __attribute__((always_inline)) void __internal_accurate_sincosf(float a, float *sptr, float *cptr)
{
...
static __inline__ __attribute__((always_inline)) float __internal_accurate_sinf(float a)
{
  ...
  return s;
# 9555 "/usr/local/cuda/bin/..//include/math_functions.h" 3
}
...
static __inline__ __attribute__((always_inline)) float __internal_accurate_cosf(float a)
{
  ...
  __internal_accurate_sincosf (a, &s, &c);
  return c;
# 9575 "/usr/local/cuda/bin/..//include/math_functions.h" 3
}
...
static __inline__ __attribute__((always_inline)) float __internal_cos_offset_f(float a, float offset)
{
  float z;
  int i;
...
static __inline__ __attribute__((always_inline)) float atan2f(float a, float b)
{
  ...
  if (t1 == 0.0f && t2 == 0.0f) {
  ...
  } else if ((t1 == __int_as_float(0x7f800000)) && (t2 == __int_as_float(0x7f800000))) {
    ...
    if (t2 > t1) t0 = 1.570796327f - t0;
    if (__float_as_int(b) < 0) t0 = 3.141592654f - t0;
    t0 = __internal_copysignf_pos(t0, a);
    t1 = t1 + t2;
    if (!(t1 <= __int_as_float(0x7f800000))) t0 = t1;
  }
  return t0;
}
...
static __inline__ __attribute__((always_inline)) float cbrtf(float a)
{
  ...
  s = fabsf (a);
  t = __internal_fast_exp2f (0.333333333f * __log2f(s));
...
static __inline__ __attribute__((always_inline)) float y0f(float a)
{
  ...
  if (t <= 4.4678848e-1f) {
    ...
    r += 0.636619772f * __internal_accurate_logf(t) * j0f(t);
...
static __inline__ __attribute__((always_inline)) float y1f(float a)
{
  ...
  if (t < 1.175494351e-38f) {
    ...
    r *= t;
    r += 0.636619772f * (__internal_accurate_logf(t) * j1f(t) - 1.0f /t);
...
# 10546 "/usr/local/cuda/bin/..//include/math_functions.h" 3
...
{
# 10618 "/usr/local/cuda/bin/..//include/math_functions.h" 3
  float p, q;
# 10628 "/usr/local/cuda/bin/..//include/math_functions.h" 3
...
{
# 10658 "/usr/local/cuda/bin/..//include/math_functions.h" 3
  float p, q, h, l, t;
  if (a <= 0.813f) {
    p = 1.0f - erff(a);
  } else {
...
{
# 10714 "/usr/local/cuda/bin/..//include/math_functions.h" 3
  float x, t1, t2, t3, t4;
  x = fabsf(a);
  if (x < 10.055f) {
    if (x <= 0.813f) {
...
static __inline__ __attribute__((always_inline)) float modff(float a, float *b)
{
  ...
  if (__finitef(a)) {
    ...
    *b = a;
    t = __internal_copysignf_pos (0.0f, a);
  } else {
    *b = a + a;
    t = a + a;
  }
...
# 10961 "/usr/local/cuda/bin/..//include/math_functions.h" 3
    while (scaled_b >= b) {
      if (a >= scaled_b) {
        a -= scaled_b;
      }
    ...
    res = orig_a;
    if (!(b <= __int_as_float(0x7f800000))) res += orig_b;
    if (!(a > 0.0f)) res += orig_a;
  }
  return res;
}
...
# 11001 "/usr/local/cuda/bin/..//include/math_functions.h" 3
    float scaled_b = __int_as_float ((__float_as_int(b) & 0x007fffff) |
                                     (__float_as_int(a) & 0x7f800000));
    if (scaled_b > a) {
      scaled_b *= 0.5f;
    ...
    if (a == scaled_b) {
      return __internal_copysignf_pos (0.0f, orig_a);
    }
...
# 11077 "/usr/local/cuda/bin/..//include/math_functions.h" 3
    float scaled_b = __int_as_float ((__float_as_int(b) & 0x007fffff) |
                                     (__float_as_int(a) & 0x7f800000));
    if (scaled_b > a) {
      scaled_b *= 0.5f;
...
# 11115 "/usr/local/cuda/bin/..//include/math_functions.h" 3
  if (a >= 1.175494351e-38f) {
    twoa = 2.0f * a;
...
# 55 "/usr/local/cuda/bin/..//include/math_functions_dbl_ptx1.h" 3
...
# 114 "/usr/local/cuda/bin/..//include/math_functions_dbl_ptx1.h" 3
...
# 20 "cmf.cu" 2
# 10 "cmf.cu"
__attribute__((global)) __attribute__((__used__)) void _Z8mykernelPf(
# 10 "cmf.cu"
float *t){
# 10 "cmf.cu"
{
...
# 18 "cmf.cu"
__attribute__((global)) __attribute__((__used__)) void _Z9mykernel2Pf(
# 18 "cmf.cu"
float *t){
# 18 "cmf.cu"
{
